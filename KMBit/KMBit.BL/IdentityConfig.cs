...
namespace KMBit.BL
{
        ...
        Microsoft.AspNet.Identity.IUserTwoFactorStore<ApplicationUser, int>
    {
        ...
        public Task SetPhoneNumberAsync(ApplicationUser user, string phoneNumber)
        {
            ...
            this.content.Users.Attach(user);
            return this.content.SaveChangesAsync();
        }
        ...
        public Task RemoveLoginAsync(ApplicationUser user, UserLoginInfo login)
        {
            ...
            UserLogins log = (from ul in content.UserLogins where ul.UserId==user.Id && ul.ProviderKey==login.ProviderKey && ul.LoginProvider==login.LoginProvider select ul).FirstOrDefault<UserLogins>();
            if(log!=null)
            {
                content.UserLogins.Remove(log);
                content.SaveChanges();
            }
            return Task.FromResult<Object>(null);
        }
        ...
        public Task<ApplicationUser> FindAsync(UserLoginInfo login)
        {
            ...
            UserLogins uLogin = (from ul in content.UserLogins where ul.ProviderKey==login.ProviderKey && ul.LoginProvider==login.LoginProvider select ul).FirstOrDefault<UserLogins>();

            if(uLogin!=null)
            {
                Users dbUser = (from u in content.Users where u.Id==uLogin.UserId select u).FirstOrDefault<Users>();
                if(dbUser!=null)
                {
                    return Task.FromResult<ApplicationUser>(ApplicationUser.DBUserToAppUser(dbUser));
                }
                else
                {
